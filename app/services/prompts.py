...
ASK_LOCATION_HI = (
    "आपकी खेत की लोकेशन सेव नहीं है।\n"
    "बारिश की चेतावनी और मौसम के लिए लोकेशन भेजें:\n"
    "नीचे बटन दबाएँ, या Telegram में 📎 → Location।"
)

START_WELCOME_HI = (
    "नमस्ते! मैं Krish हूँ — फसल फोटो, आवाज़, मौसम और मंडी भाव में मदद करता हूँ।\n\n"
    "बारिश की चेतावनी देने के लिए आपकी खेत की लोकेशन चाहिए।"
)

START_WELCOME_READY_HI = (
    "नमस्ते! मैं Krish हूँ। लोकेशन पहले से सेव है 📍\n"
    "फसल की फोटो, वॉइस नोट भेजें, या पूछें: आज मौसम कैसा है? / टमाटर का मंडी भाव?"
)

LOCATION_MISSING_FOOTER = (
    "\n\n📍 बारिश अलर्ट के लिए लोकेशन भेजें — नीचे बटन, या 📎 → Location।"
)
